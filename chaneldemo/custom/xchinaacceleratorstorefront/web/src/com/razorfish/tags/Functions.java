...
public class Functions
{
	 ...
	 * xchinaacceleratorstorefront.lazyload is set to true. Else the HTML image tag is being created and returned as it
	...
	{
		if (getConfigurationService(getCurrentRequest()).getConfiguration().getBoolean("xchinaacceleratorstorefront.lazyload",
				false))
		{
