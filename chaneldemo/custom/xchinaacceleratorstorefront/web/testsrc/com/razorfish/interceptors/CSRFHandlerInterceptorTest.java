 ...
 */
package com.razorfish.interceptors;
...
import com.razorfish.util.CSRFHandlerInterceptor;
import com.razorfish.util.CSRFTokenManager;
...
{
	private final String SESSION_CSRF_ATTRIBUTE = "com.razorfish.util.CSRFTokenManager.tokenval";
