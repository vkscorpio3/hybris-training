 ...
 *  
 */
package com.razorfish.wechataddon.hmc;
...
/**
 * Provides necessary meta information about the wechataddon hmc extension.
 * 
 * 
 * @version ExtGen v5.4.0.5
 */
public class WechataddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(WechataddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.razorfish.wechataddon.hmc.locales";
