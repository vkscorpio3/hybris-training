...
public class UnifiedorderReqData
{
	...
	public UnifiedorderReqData(final String authCode, final String body, final String attach, final String outTradeNo,
			final int totalFee, final String deviceInfo, final String spBillCreateIP, final String timeStart,
			final String timeExpire, final String goodsTag, final String detail, final String fee_type, final String notify_url,
			final String trade_type, final String product_id, final String limit_pay, final String openid)
	{
	...
	public void setTotal_fee(final int total_fee)
	{
	...
	public void setSpbill_create_ip(final String spbill_create_ip)
	{
	...
	public void setTime_expire(final String time_expire)
	{
	...
	public void setGoods_tag(final String goods_tag)
	{
	...
	public void setLimit_pay(final String limit_pay)
	{
