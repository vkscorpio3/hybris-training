 ...
 */
public class AmwayHazelcastCache implements AmwayCache
{
	...
	public AmwayHazelcastCache(final IMap<Object, Object> map)
	{
		this.map = map;
	}
	...
	{
		final Object value = fromStoreValue(this.map.get(key));
	...
	{
		final Object result = map.putIfAbsent(key, toStoreValue(value));
